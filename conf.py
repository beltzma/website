...
BLOG_AUTHOR = "Marcel Beltz"  # (translatable)
BLOG_TITLE = "b9i.de"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://b9i.de/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://b9i.de/"
BLOG_EMAIL = "marcel@beltz.info"
BLOG_DESCRIPTION = "This is a blog site for me."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/rss.xml', 'RSS'),
        ('/galleries/', 'Pics'),
        ('http://file.b9i.de', 'seafile'),
        ('/categories/3d-printer.html', '3D Printer')
...
DEPLOY_COMMANDS = {
 'default': [
     "rsync -rav output/* rs000217:/srv/www/default/"]
 }
